...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($_SESSION['user_id'])) {
        ...
        header("Location: login.php?redirect=furniture.php");
        exit();
    }

    $furniture_no = $_POST['furniture_no'];
    ...
    $sql = "INSERT INTO furniture (furniture_no, department, location, name, branch, prn_no, complaint_description) VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    if ($stmt) {
        $stmt->bind_param("sssssss", $furniture_no, $department, $location, $name, $branch, $prn_no, $complaint_description);
        if ($stmt->execute()) {
...
<body>
    ...
    <div class="login-container">
        <div class="form-container">
            <form class="login-form" action="furniture.php" method="POST" onsubmit="return checkLoginStatus()">
                ...
                <div class="input-group">
                    <label for="furniture_no">Furniture No:</label>
                    <input type="text" id="furniture_no" name="furniture_no" required>
                </div>
                <div class="input-group">
    ...
    <script>
        function checkLoginStatus() {
            <?php if (!isset($_SESSION['user_id'])): ?>
                ...
                window.location.href = "login.php?redirect=furniture.php";
                return false;
            <?php endif; ?>
            return true;
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (qrData) {
                try {
                    ...
                    document.getElementById('furniture_no').value = decodedData['Furniture no'] || '';
